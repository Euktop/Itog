...
namespace Itog2.Tests2
{
    ...
    public class DataManagerTests
    {
        ...
        public void TestLoadAndSaveEntities()
        {
            ...
            Assert.AreEqual(testData.Count, loadedEntities.Count, "The number of loaded entities does not match.");
            Assert.AreEqual(testData[0].Name, loadedEntities[0].Name);
            Assert.AreEqual(testData[1].Name, loadedEntities[1].Name);
